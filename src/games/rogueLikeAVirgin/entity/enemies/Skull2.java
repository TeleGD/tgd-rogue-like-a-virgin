...
public class Skull2 extends Enemy{
	...
	public Skull2(World world, float x, float y) {
		super(world, x, y);
		hp=3;
		this.imgB=AppLoader.loadPicture("/images/rogueLikeAVirgin/squeletteMocheBas.png");
		this.imgT=AppLoader.loadPicture("/images/rogueLikeAVirgin/squeletteMocheHaut.png");
		this.imgR=AppLoader.loadPicture("/images/rogueLikeAVirgin/squeletteMocheDroite.png");
		this.imgL=AppLoader.loadPicture("/images/rogueLikeAVirgin/squeletteMocheGauche.png");
	...
	private void shoot() {
		new Projectile(this.world, this.x+width/2,this.y+height/2,false,(this.world.player.getX()-x)/800,(this.world.player.getY()-y)/800);
	}
